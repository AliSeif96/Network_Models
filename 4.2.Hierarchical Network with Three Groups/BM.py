...
sizes = [334, 333, 333]  # Adjusted group sizes so the total is 1000
k = 16  # Desired average degree

# Adjusted connection probabilities
p_intra = 0.045  # Probability of connection within a group (higher internal connectivity)
p_inter = 0.002  # Probability of connection between groups (lower inter-group connectivity)

# Define the connection probabilities matrix for 3 groups0.045,0.002
