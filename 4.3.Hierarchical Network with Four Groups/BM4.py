...
probs = [
    [p_intra, p_inter, p_inter, p_inter],  # Group 1 connections
    [p_inter, p_intra, p_inter, p_inter],  # Group 2 connections
    [p_inter, p_inter, p_intra, p_inter],  # Group 3 connections
    [p_inter, p_inter, p_inter, p_intra]   # Group 4 connections
]
